  ...
  const config: PricingConfig = {
    minimumAmounts: {
      [PaymentType.CONSULTATION]: 
        parseFloat(process.env.PRICE_CONSULTATION_MIN || '35'),
      [PaymentType.DRAWING_CONSULTATION]: 
        parseFloat(process.env.PRICE_DRAWING_CONSULTATION_MIN || '50'),
      [PaymentType.TATTOO_DEPOSIT]: 
        parseFloat(process.env.PRICE_TATTOO_DEPOSIT_MIN || '75'),
      [PaymentType.TATTOO_FINAL]: 
        parseFloat(process.env.PRICE_TATTOO_FINAL_MIN || '100')
    },
