...
// Configuration - can be passed as command line argument
const SUPER_USER_EMAIL = process.argv[2] || 'support@ubiship.io';
const SUPER_USER_NAME = 'UbiShip Support Admin';
