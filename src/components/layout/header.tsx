...
export function Header() {
  ...
  // Split navigation into two groups of 4
  const leftNavItems = navigationItems.slice(0, 4);
  const rightNavItems = navigationItems.slice(4, 8);
    ...
    <header className={`fixed top-0 left-0 right-0 z-50 min-h-[80px] transition-all duration-500 ${headerClasses}`}>
      <div className="container mx-auto px-6 md:px-8 h-full">
        ...
        <div className="flex items-center justify-between h-full">
          ...
          {/* Desktop Navigation - Split into left and right groups */}
          <nav className="hidden md:flex items-center justify-between flex-1 max-w-5xl mx-auto">
            {/* Left group - 4 links */}
            ...
            <div className="flex-1 min-w-32"></div>
