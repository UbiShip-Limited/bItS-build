...
export function HorizontalSplitParallax() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#080808] relative py-16 overflow-hidden">
              ...
              <div className={`flex ${isReversed ? 'flex-row-reverse' : 'flex-row'} bg-[#080808] border border-[#C9A449]/20 rounded-lg overflow-hidden min-h-[400px] group hover:border-[#C9A449]/40 transition-all duration-500`}>
                ...
                <div className="w-1/2 relative flex flex-col justify-center px-8 py-8">
                  ...
                  <div className="relative z-10">
                    ...
                    {/* CTA Button */}
                    <button className="group relative overflow-hidden bg-transparent border border-[#C9A449]/70 text-white hover:bg-[#C9A449]/10 hover:border-[#C9A449] transition-all duration-300 px-6 py-3 font-body tracking-widest uppercase text-xs font-medium">
      ...
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 flex items-center space-x-4 z-20">
        {/* Ornamental line */}
        <div className="w-8 h-[0.5px] bg-gradient-to-r from-transparent to-[#C9A449]/40"></div>
        ...
        <div className="flex space-x-3">
          {sections.map((_, index) => (
            <motion.div
              key={index}
              className="w-2 h-2 border border-[#C9A449]/40 rotate-45 relative"
        ...
        {/* Ornamental line */}
        <div className="w-8 h-[0.5px] bg-gradient-to-l from-transparent to-[#C9A449]/40"></div>
      </div>
    </div>
  )
}